 ...
 * 
 * Introduced in Java 7 – Java allows us to declare resources to be used in a try block with the assurance that the
 * resources will be closed after the execution of that block. The resources declared must implement the
 ...
 * Before Java 9, we could only use fresh variables inside a try-with-resources block but after java 9 we can use
